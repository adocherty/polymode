...
class tester_layered(TestCase):
    ...
    def _create_problem(self):
        ...
        # Create the solver
        self.solver = LayeredSolver.DefaultSolver(self.wg)
    ...
    def test_solve(self):
        ...
        self.modes1 = self.solver(wl, 1, nefflist=[1.474, 1.44861])
        ...
        assert_array_equal(neffs0, exact_neffs0)
        assert_array_equal(neffs1, exact_neffs1)

        #Check field profiles

class tester_finitedifference(TestCase):
    Nx = (1e3,1)
    ...
    def test_solve(self):
        ...
        #Solve for 2 modes in mode class 0
        self.modes0 = self.solver(wl, 0, nefflist=[1.463, 1.463])
