...
def findzero_delves(f, fprime, z0=0, R=1, N=None, alpha=1, trange=None, tolerance=1e-6):
	'''
	...
	while (residue>tolerance) and (niter<maxiter):
...
def findzero_adr(f, z0=0, R=1, N=None, nroot=None, tolerance=1e-6, alpha=1, trange=None, maxiter=10):
	'''
	Cauchy integral method for finding the zeros of an analytic function
...
def findzero_carpentier(f, z0=0, R=1, N=None, tolerance=1e-6, alpha=1, trange=None, force=False, maxiter=10):
	'''
	Cauchy integral method for finding the zeros of an analytic function
	doesn't require the derivative of the function
	f: function of a single variable returns function value
...
def findzero_matrix(A, z0=0, R=1, N=None, tolerance=1e-6, maxiter=10):
	'''
